 ...
 */
static inline long metal_clock_get_rate_hz(const struct metal_clock *clk) { return clk->vtable->get_rate_hz(clk); }
 ...
 */
static inline long metal_clock_set_rate_hz(struct metal_clock *clk, long hz)
{
 ...
 */
static inline void metal_clock_register_pre_rate_change_callback(struct metal_clock *clk, metal_clock_pre_rate_change_callback cb, void *priv)
{
 ...
 * @param priv Private data for the callback handler
 */
static inline void metal_clock_register_post_rate_change_callback(struct metal_clock *clk, metal_clock_post_rate_change_callback cb, void *priv)
{

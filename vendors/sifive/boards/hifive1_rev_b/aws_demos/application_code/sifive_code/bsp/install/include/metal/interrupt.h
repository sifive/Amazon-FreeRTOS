 ...
 */
static inline void metal_interrupt_init(struct metal_interrupt *controller)
{
 ...
 */
static inline int metal_interrupt_register_handler(struct metal_interrupt *controller,
                                          int id,
 ...
 * @return 0 upon success
 */
static inline int metal_interrupt_enable(struct metal_interrupt *controller, int id)
{
 ...
 * @return 0 upon success
 */
static inline int metal_interrupt_disable(struct metal_interrupt *controller, int id)
{
 ...
 * @return 0 upon success
 */
static inline int metal_interrupt_vector_enable(struct metal_interrupt *controller,
                                       int id, metal_vector_mode mode)
{
 ...
 * @return 0 upon success
 */
static inline int metal_interrupt_vector_disable(struct metal_interrupt *controller, int id)
{
...
static inline int _metal_interrupt_command_request(struct metal_interrupt *controller,
					 int cmd, void *data)
{
